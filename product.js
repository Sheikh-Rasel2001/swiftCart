...
function displayProducts(products) {
    ...
    products.forEach(product => {
      ...
      <div class="flex justify-between items-center px-4 mb-4">
        <button onclick="showProductDetails('${product.id}')" class="bg-gray-300 border-1 px-3 py-1 rounded-md hover:bg-blue-800 transition duration-300 hover:text-gray-100"><i class="fa-regular fa-eye"></i> Details</button>
